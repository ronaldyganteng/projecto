...
async def reedme(e):
    await e.edit(
        ...
        "\n[Archiztec's README.md file](https://github.com/ronaldyganteng/projecto/blob/master/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "Here Is My Repository User-bot [Repo](https://github.com/ronaldyganteng/projecto)"
    )
